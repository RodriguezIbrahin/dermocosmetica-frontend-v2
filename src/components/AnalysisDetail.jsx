                    ...
                    <div className="-mt-12 flow-root px-4 sm:-mt-8 sm:flex sm:items-end sm:px-6 lg:-mt-16">
                      ...
                      <div className="mt-6 sm:ml-6 sm:flex-1">
                        ...
                        <div className="mt-5 flex flex-wrap space-y-3 sm:space-y-0 sm:space-x-3">
                          <button
                            type="button"
                            className="inline-flex w-full shrink-0 items-center justify-center rounded-md bg-rose-400 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg_rose focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-400 sm:flex-1"
                          >
                            Ver Resultados
                          </button>
                          <button
